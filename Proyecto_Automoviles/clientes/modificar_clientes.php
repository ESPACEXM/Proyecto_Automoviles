...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="container">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button class="btn btn-success me-md-2" id="btnModificarUsuario" name="btnModificarUsuario" type="button"
                    data-bs-toggle="modal" data-bs-target="#formModificarUsuario">Modificar Clientes</button>
            </div>
    ...
    <div class="modal fade" id="formModificarUsuario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title" id="formModificarUsuario">Modificar Usuario</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <input type="numero" class="form-control" id="password" placeholder="aqui va tu clave">
